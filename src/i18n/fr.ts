export const fr = {
  ...
  playbooks: {
    ...
    actionBadge: {
      send_email: "Alerte email",
      export_csv: "Export CSV",
      log_note: "Note interne",
      flag_for_review: "À examiner",
    } as Record<string, string>,
    newModal: {
      step1Title: "Choisir un modèle de playbook",
      step2Title: "Personnaliser le playbook",
      nameLabel: "Nom du playbook",
      namePlaceholder: "Ex : Alerte churn critique Q3",
      continueBtn: "Continuer →",
      createBtn: "Créer le playbook",
      creating: "Création en cours…",
      success: "Playbook créé",
      templateSummary: "Modèle sélectionné",
  ...
  settings: {
    ...
    plans: {
      tabLabel: "Plans & Sièges",
      tabDescription: "Associez vos plans Stripe à un tier et une limite de sièges. Ces informations permettent de calculer les scores d'expansion de vos comptes clients.",
      colProduct: "Produit",
      colPrice: "Tarif",
      colInterval: "Intervalle",
      colPlanTier: "Plan Sentio",
      colSeats: "Sièges max",
      colStatus: "Statut",
      intervalMonth: "Mensuel",
      intervalYear: "Annuel",
      planUndefined: "— Non défini —",
      seatPlaceholder: "ex : 10",
      unlimited: "Illimité",
      statusActive: "Actif",
      ...
      save: "Enregistrer",
      saving: "Enregistrement…",
      saveSuccess: "Mapping enregistré.",
      saveError: "Erreur lors de l'enregistrement.",
      seatLimitError: "La limite de sièges doit être un entier supérieur à 0.",
      emptyState: "Aucun plan détecté dans votre compte Stripe. Vérifiez que votre clé API est connectée et que vous avez des abonnements actifs.",
    },
  },
