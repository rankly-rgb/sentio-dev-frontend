export const fr = {
  ...
  onboardingV2: {
    promise: {
      mainText: "Dans 48 heures, vous saurez exactement quel client risque de vous quitter ce mois-ci — et vous aurez déjà agi dessus.",
      subText: "Sentio analyse vos données Stripe et identifie les signaux de churn que vous ne voyez pas dans vos tableaux Excel.",
      cta: "Je veux voir ça →",
    },
    stripe: {
      ...
      skipLink: "Continuer avec les données démo →",
